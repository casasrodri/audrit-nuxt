...
import { getModalBuscador } from '../services/modals.js'
...
<template>
    <!-- Modal toggle -->
    <button data-modal-target="modalBuscador" class="hidden" type="button" />

    <!-- Main modal -->
    <div id="modalBuscador" tabindex="-1" aria-hidden="true"
        ...
        <div class="relative p-4 w-full max-w-2xl max-h-full">
            ...
            <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                ...
                <div class="flex items-center justify-between p-4 md:p-5 border-b rounded-t dark:border-gray-600">
                    <div class="relative w-full mr-2">
                        <div class="absolute inset-y-0 start-0 flex items-center ps-3.5 pointer-events-none">
                            <Icon name="iconamoon:search" size="20" color="#557A7A" />
                        </div>
                        <input type="text" id="focusBusqueda" v-model="textoBuscado"
                    ...
                    <button id="cerrarModalBuscador" type="button"
                        class="text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm w-8 h-8 ms-auto inline-flex justify-center items-center dark:hover:bg-gray-600 dark:hover:text-white"
                        data-modal-hide="modalBuscador">
                ...
                <!-- <div class="flex items-center p-4 md:p-5 border-t border-gray-200 rounded-b dark:border-gray-600">
                    <button data-modal-hide="modalBuscador" type="button"
